...
extern void zeromode ( Database *,int); // This function finds the mode of the columns and inputs it in the cell with 0s in them
extern void print( Database*);
extern void freeData( Database*); //This function frees the memory of the database
